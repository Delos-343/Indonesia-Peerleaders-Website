        ...
        <footer className="p-4 bg-white rounded-t-lg shadow md:px-6 md:py-8 dark:bg-[#15365e]">
            <div className="sm:flex sm:items-center sm:justify-between">
                <a href="https://flowbite.com" className="flex items-center mb-4 sm:mb-0">
                    <img src="https://i.postimg.cc/hj6VHbD5/IPL-LOGO-15.png" className="mr-3 h-20" alt="Flowbite Logo" />
                </a>
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" class="hover:underline">Delos-343</a>. All Rights Reserved.
            </span>
        </footer>
    </div>
  )
